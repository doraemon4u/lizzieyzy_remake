...
/**
 * Remote KataEstimate over SSH. Migrated from deprecated ganymed-ssh2 to the maintained JSch fork
 * (com.github.mwiede:jsch); public method names unchanged.
 */
public class EstimateEngineSSHController {
  private Session session;
  private ChannelExec channel;
  private RemoteConnect newConnect;
  private KataEstimate owner;
  private boolean isPreload;

  public EstimateEngineSSHController(
      KataEstimate owner, String ip, String port, boolean isPreLoad) {
